...
router.post('/reader-followup', auth, quotaGuard, ReadingController.readerFollowup);
router.post('/daily-fortune', auth, quotaGuard, ReadingController.dailyFortune);
router.get('/horoscope', auth, ReadingController.horoscope);
